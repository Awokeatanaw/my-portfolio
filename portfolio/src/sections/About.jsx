...
export default function About() {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: <Server className="w-8 h-8 md:w-10 md:h-10 text-white" />,
      iconBg: "bg-gradient-to-br from-purple-500 to-purple-600",
    },
    {
      value: "15+",
      label: "Technologies",
      icon: <Database className="w-8 h-8 md:w-10 md:h-10 text-white" />,
  ...
  return (
    <section
      ...
      className="
        ...
        px-4 md:px-6 lg:px-10 xl:px-16 2xl:px-20
      "
    >
      <div className="w-full max-w-[1920px] mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-gray-900 via-purple-900 to-purple-600 bg-clip-text text-transparent">
            About Me
          </h2>
        </motion.div>

        {/* FLEX CONTAINER — NO GAP ON LAPTOP+ */}
        <div className="flex flex-col lg:flex-row items-stretch -mx-2">
          {/* LEFT COLUMN — Original text + larger stats */}
          <motion.div
          ...
          >
            <div className="space-y-8 md:space-y-10">
              {/* ✅ ORIGINAL PARAGRAPH TEXT — FULL LENGTH */}
              ...
              <div className="flex flex-wrap gap-3">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-5 py-2.5 bg-gradient-to-r from-purple-50 to-pink-50 text-purple-700 font-semibold rounded-full text-sm md:text-base"
                  >
                    {tag}
                  </span>
                ))}
              ...
              {/* ✅ LARGER STATS CARDS — EQUAL HEIGHT TO COMPETENCIES */}
              <div className="grid grid-cols-2 gap-4 md:gap-6">
                {stats.map((stat, index) => (
                  ...
                  >
                    <div className={`inline-flex p-3.5 rounded-2xl ${stat.iconBg} shadow-md mb-3`}>
                      {stat.icon}
                    </div>
                    <h4 className="text-3xl md:text-4xl font-black text-purple-600 mb-1">
                      {stat.value}
                    </h4>
          ...
          {/* RIGHT COLUMN — Smaller photo + competencies */}
          <motion.div
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
            <div className="flex flex-col space-y-8">
              {/* ✅ SMALLER PHOTO */}
              <div className="relative max-w-xs md:max-w-sm mx-auto lg:mx-0">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-400/20 to-pink-400/20 blur-xl -z-10" />
                <div className="p-1 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl">
              ...
              {/* ✅ COMPETENCIES — Same visual weight as stats */}
              <div className="bg-white rounded-2xl shadow-lg p-6 border border-purple-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-5 text-center lg:text-left">
                  Core Competencies
                </h3>
