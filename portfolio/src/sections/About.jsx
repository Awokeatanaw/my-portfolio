  ...
  const stats = [
    {
      ...
      icon: <Code className="w-12 h-12 3xl:w-14 3xl:h-14 text-white" />,
      iconBg: "bg-gradient-to-br from-indigo-500 to-indigo-600",
    },
    {
      value: "6+",
      label: "Projects Completed",
      icon: <Server className="w-12 h-12 3xl:w-14 3xl:h-14 text-white" />,
      iconBg: "bg-gradient-to-br from-purple-500 to-purple-600",
    },
    {
      value: "15+",
      label: "Technologies",
      icon: <Database className="w-12 h-12 3xl:w-14 3xl:h-14 text-white" />,
      iconBg: "bg-gradient-to-br from-pink-500 to-pink-600",
    },
    {
      value: "",
      label: "Reliable Project Delivery",
      icon: <Smartphone className="w-12 h-12 3xl:w-14 3xl:h-14 text-white" />,
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1700px] mx-auto">
        ...
        >
          <h2 className="text-5xl md:text-6xl lg:text-7xl 3xl:text-8xl font-black bg-gradient-to-r from-gray-900 via-purple-900 to-purple-600 bg-clip-text text-transparent">
            About Me
          </h2>
        </motion.div>

        {/* MAIN GRID */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 3xl:gap-28 items-start">
          ...
          >
            <div className="space-y-6 text-gray-700 text-base md:text-lg lg:text-xl 3xl:text-2xl leading-relaxed">
              <p>
              ...
              {tags.map((tag) => (
                <span
                  ...
                  className="
                    ...
                    3xl:px-10 3xl:py-5 3xl:text-lg
                  "
                >
                  {tag}
                </span>
          ...
          {/* RIGHT COLUMN — PHOTO + COMPETENCIES UNDER */}
          <motion.div
            initial={{ opacity: 0, x: 60 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.9 }}
                ...
                {competencies.map((comp, index) => (
                  <div key={index}>
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-base md:text-lg 3xl:text-xl font-medium text-gray-800">
                        {comp.name}
                      </span>
                      <span className="text-xl 3xl:text-2xl font-bold text-purple-600">
                        {comp.percentage}%
                      </span>
                    </div>
